...
CREATE TABLE `sms_attendance` (
  ...
  `attendance_hour` time(2) NOT NULL,
...
(1,6,2,1,1,'2019/06/22','00:00:00.00'),
(2,5,2,1,4,'2019/06/22','00:00:00.00'),
(3,3,2,1,3,'2019/06/22','00:00:00.00'),
(4,7,4,4,3,'2019/06/22','00:00:00.00');
...
(1,'admin','mustafa','admin','202cb962ac59075b964b07152d234b70','male','123456789','Web developer','','administrator','active',''),
(2,'ali','mustafa','adx@live.com','7b24afc8bc80e548d66c4e7ff72171c5','male','','','','general','active','');
...
-- Dump completed on 2022-07-04  1:15:20
