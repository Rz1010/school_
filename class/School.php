...
#this is fatel please check permissions before publishing
            $conn = new mysqli($this->hostName, "root", "toor", "webdamn_demos");
...
public function subjectLister(){		
	...
	public function addTeacher () {
		if($_POST["teacher_name"]) {
			$insertQuery = "INSERT INTO ".$this->teacherTable."(teacher,tnumb) 
				VALUES ('".$_POST["teacher_name"]."','".$_POST["teacher_number"]."')";
			$userSaved = mysqli_query($this->dbConnect, $insertQuery);
		}
	}
